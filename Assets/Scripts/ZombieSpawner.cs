...
public class ZombieSpawner : MonoBehaviour
{
    ...
    private void CreateZombie()
    {
        ...
        //이거는 익명함수(Anonymous Function)라고 부름.
        //미리 정의하지 않고 실행중인 코드 내에서 즉석으로 실시간으로 생성하는 함수.
        //실시간으로 일회용 메서드를 생성하고 이벤트에 등록 가능.
        //간단한 함수를 정의할 때 사용!
        //이걸 정의하는(표현하는) 방식을 람다식이라고 함.
        // 사망한 좀비를 리스트에서 제거
        zombie.onDeath += () => zombies.Remove(zombie);
        // 사망한 좀비를 10초 뒤에 파괴
        //여기서는 리스트에서 제거하면서 한번에 게임오브젝트까지 제거하는 것!

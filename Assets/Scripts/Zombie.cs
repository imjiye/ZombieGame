...
public class Zombie : LivingEntity
{
    ...
    public override void Die()
    {
        ...
        //이 아래부분은 공통된 부분이 아니라 좀비에 한정된 부분이라 추가해서 사용한 것!
        ...
        //여기서 바로 없애면 애니메이션과 소리가 안나기 때문에 지연시키도록 함.
    }

    private void OnTriggerStay(Collider other)
    {
        //OnTriggerStay는 트리거 충돌 안에 있는 동안 계속 실행
        //OnTriggerEnter는 트리거 충돌이 일어나는 순간 한 번 실행
        //OnTriggerExit는 트리거 충돌에서 벗어나는 순간 한 번 실행
